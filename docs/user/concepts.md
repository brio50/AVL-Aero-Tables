...
```
results.csv                → total + stability + control data (all cases)
results_stab_deriv.csv     → stability derivatives (neutral-control cases only)
results_ctrl_deriv.csv     → control derivatives (neutral-control cases only)
```
...
└── 📁 bd_2026-05-15-143022/
    ├── 📄 results.csv              ← all cases: Alpha, Beta, CLtot, derivatives …
    ├── 📄 results_stab_deriv.csv   ← neutral-control stability derivatives
    ├── 📄 results_ctrl_deriv.csv   ← neutral-control control derivatives
...
| File | Contents | Rows |
|---|---|---|
| `results.csv` | All keys from every `.st` case — Alpha, Beta, CLtot, deflections, stability derivatives, control derivatives | All cases |
| `results_stab_deriv.csv` | Stability derivatives (CLa, CLb, CLp, …, Cnr) | Neutral-control cases only |
| `results_ctrl_deriv.csv` | Control derivatives (CLd01, CYd01, …) | Neutral-control cases only |
